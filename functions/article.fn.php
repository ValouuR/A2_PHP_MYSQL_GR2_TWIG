 ...
 * @return array
 */
function getArticlesFromCategory(PDO $db, $categoryId)
{
 ...
 * @return array
 */
function getArticlesFromTag(PDO $db, $tagId)
{
    $sql = 'SELECT * FROM article JOIN article_tag at ON at.article_id= :article_id';
...
{
    $sql    = 'SELECT COUNT(*) AS nb FROM article WHERE enabled=1';
